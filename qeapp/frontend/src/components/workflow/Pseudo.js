    ...
    const fetchCutoffs = async () => {
      try {
        ...
        if (librarySelection === 'SSSP efficiency') {
          ...
          if (spinOrbit === 'on') {
            pseudoFamily = `PseudoDojo/${PSEUDODOJO_VERSION}/${exchangeFunctional}/FR/standard/upf`;
          } else {
            pseudoFamily = `PseudoDojo/${PSEUDODOJO_VERSION}/${exchangeFunctional}/SR/standard/upf`;
          }
        } else if (librarySelection === 'PseudoDojo stringent') {
          if (spinOrbit === 'on') {
            pseudoFamily = `PseudoDojo/${PSEUDODOJO_VERSION}/${exchangeFunctional}/FR/stringent/upf`;
          } else {
            pseudoFamily = `PseudoDojo/${PSEUDODOJO_VERSION}/${exchangeFunctional}/SR/stringent/upf`;
          }
        }
        const newData = { ...data,
